  ...
  return (
    <button
      className={cn(
        ...
        variant === "default" && "bg-primary text-primary-foreground shadow-sm shadow-primary/10 hover:bg-primary/90",
        variant === "secondary" && "border border-white/[0.06] bg-white/[0.045] text-secondary-foreground hover:bg-white/[0.07]",
